...
void		Mapper::map_tab_gen(double target_sig_energy)
{
	...
	case MOD_SUPER_16QAM3:	mapping_SUPER_16QAM3(m_2d_map_tab, target_sig_energy, m_N_2d_const, 0.0); break;   //FOR ITER NEW SWITCH ALGORITHM
...
void mapping_SUPER_16QAM3(Complex<double>* signal, double a_s, int M, double shift) {
	int i;
	double alpha = 1 + a_s, beta = a_s;
