#include "Simulator.h"
#if NOW == NEW_ITER_SMALL //Conventional Superposition
#include <iostream>
#include <fstream>	
#include <vector>
#include <string>
...
//				if (Detect.Packet(code_source, decoded_source, SP_NINFOBITperSYM) && !Detect.Packet(code_relay, decoded_relay, SP_NINFOBITperSYM)) {
//
