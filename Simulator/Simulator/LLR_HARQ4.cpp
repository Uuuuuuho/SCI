#include "Simulator.h"
#if NOW == LLR_HARQ4    //Phase superposition
#include <iostream>
#include <fstream>	
#include <vector>
#include <string>
	...
	do {
		...
		for (int h = 0; h < Frame; ++h)
		{
			...
			case(QPSK): {
				...
				SOURCE_Map.PSK8_Mapping(encoded_source, encoded_relay, RD_TX);
//              RELAY_Map.QPSK_Mapping(encoded_relay, tmp_RD_TX);
//              RELAY_Map.rot(tmp_RD_TX,45);
