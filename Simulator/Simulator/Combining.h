...
public:
	...
	void LLR_MRC_COMB(FADING FAD_MOD, double SNR_SD, vector<double> h_sd, std::vector<vector<double>> LLR_FIRST,
		double SNR_RD, vector<double> h_rd, std::vector<vector<double>> &LLR_SECOND);
	void LLR_EGC_COMB(FADING FAD_MOD, double SNR_SD, vector<double> h_sd, std::vector<vector<double>> LLR_FIRST,
		double SNR_RD, vector<double> h_rd, std::vector<vector<double>> &LLR_SECOND);
